...
Config.Inventory = 'ox-inventory' -- 'ox-inventory', 'qb/aj/lj-inventory' or 'custom' -- IF custom goto custom-client and custom-server! 
...
Config.Using710Crypto = false --- Optional its for the script and will incorporate the crypto system directly into playerdata calls.
...
ShConfig = { --- THIS IS A SHARED CONFIG -- Is what this means is you can call this config in any resource with Framework.Config then whatever option you are looking for 
    ...
    MenuResource = 'qb-menu', -- qb-menu or nh-context ( make sure its the newest versions - Nirohiro made nh-context only download that one not all the other forks.)
    ...
    InputTarget = 'qtarget', -- qb-target or qtarget --- Maybe ox_target soon once they get it all working and out of beta :) 
